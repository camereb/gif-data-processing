...
#38-10-0138-01 and 17-10-0005-01
...
population <- 
  ...
  select(Year = REF_DATE,
         Geography = GEO,
         Population = VALUE) %>% 
  mutate(Geography = ifelse(Geography %in% c("Yukon","Northwest Territories",
                                         "Nunavut"), "Territories", Geography)) %>% 
...
write_csv(final_data, "CIF/data/indicator_12-3-1.csv", na = "")
